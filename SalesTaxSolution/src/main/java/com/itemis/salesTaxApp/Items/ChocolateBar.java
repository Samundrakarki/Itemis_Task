...
/**
 * ChocolateBar is a concrete class that implements BSTEItems. This is an item that can be ordered from the application. 
 *
 */
public class ChocolateBar implements BSTEItems {
	 ...
	 */
	public ChocolateBar(double price, boolean isImported, int quantity) {
		super();
		this.price = price;
